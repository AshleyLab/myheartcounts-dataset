...
**Benchmark column**: `field_chestPain`
**Raw identifier**: `chestPain` (ORKStep identifier)
**Role**: context
**Type**: binary (Yes/No)

## Source
- File: `CardioHealth/TasksAndSteps/APHDynamicParQQuizTask.m`
- Constant declaration: line 42
- Step construction: line 118
...
**Total observations**: 45,829 — **type-enforced**: 45,829 (**unique**: 2) — raw Python types seen: `bool` (45,829).
...
- Question text retrieved from NSLocalizedString key "ChestPainTitle"
