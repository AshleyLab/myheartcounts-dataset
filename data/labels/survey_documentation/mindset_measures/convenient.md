...
**Benchmark column**: `field_convenient`
**Raw identifier**: `convenient`
**Role**: context
**Type**: ordinal
...
- This item evaluates users' perception of convenience when exercising on a 4-point scale (very inconvenient to very convenient).
