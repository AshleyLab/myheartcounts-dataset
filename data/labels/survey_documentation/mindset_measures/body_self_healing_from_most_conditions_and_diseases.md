...
**Benchmark column**: `field_body_self_healing_from_most_conditions_and_diseases`
**Raw identifier**: `body_self_healing_from_most_conditions_and_diseases`
**Role**: context
**Type**: ordinal
...
## Question
> Your body is able to heal itself from most conditions and diseases.
...
## Notes
Item 19 from the Illness Mindset Inventory (IMI), a 21-item battery assessing beliefs about chronic illness and body self-healing capacity. All items use a 6-point agreement scale (Strongly Agree to Strongly Disagree).
