# chronic_illness_body_blame

**Benchmark column**: `field_chronic_illness_body_blame`
**Raw identifier**: `chronic_illness_body_blame`
**Role**: context
**Type**: ordinal
...
## Question
> Your body is to blame if you have a chronic illness.
...
## Notes
Item 20 from the Illness Mindset Inventory (IMI), a 21-item battery assessing beliefs about chronic illness and body self-healing capacity. All items use a 6-point agreement scale (Strongly Agree to Strongly Disagree).
