...
def main() -> None:
    """Build the ``METHOD`` model and run it through ``evaluate_prediction``, writing a CSV."""
    import openmhc
    ...
    results = openmhc.evaluate_prediction(model, tasks=HEADLINE_TASKS, data_dir=str(paths.root))
