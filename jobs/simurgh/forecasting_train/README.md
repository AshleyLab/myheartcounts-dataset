...
```
jobs/simurgh/forecasting_train/
...
```bash
sbatch jobs/simurgh/forecasting_train/run_dlinear.sbatch
sbatch jobs/simurgh/forecasting_train/run_mixlinear.sbatch
sbatch jobs/simurgh/forecasting_train/run_segrnn.sbatch
```
...
sbatch jobs/simurgh/forecasting_eval/run_dlinear.sbatch
...
```bash
source jobs/simurgh/forecasting_train/_common.sh
